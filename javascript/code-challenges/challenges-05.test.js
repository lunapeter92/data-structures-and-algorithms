...
const addPurchases = (arr) => {
  // Solution code here...
  let price = arr.reduce((accumulator, item) => {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let numElem = arr.reduce((accumulator, item, idx) => {
    accumulator = accumulator + idx / 2;
    return accumulator;
  }, 0)
  return numElem;
};
...
const returnNames = (arr) => {
  // Solution code here...
  let name = arr.reduce((accumulator, item, idx) => {
    accumulator[idx]= item.name;
    return accumulator;
  }, [])
  return name;
};
