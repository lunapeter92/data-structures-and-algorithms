...
const totalSum = (input) => {
  // Solution code here...
  let concat = input[0].concat(input[1], input[2])

  let newArr = concat.reduce((acc, item, idx) =>{
    acc = acc + item;
    return acc;
  },0);
...
let findMaleAndFemale = (data) => {
  // Solution code here...
  let newArr = Object.entries(data).forEach(item =>{
